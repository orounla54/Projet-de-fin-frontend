...
import ProjetsPageView from "../../components/ProjetsPageView";

function JobSidebar({projet}) {

  return (
    <div className="space-y-8 ">
      {/* md:sticky md:top-16 md:h-[calc(100dvh-64px)] md:overflow-x-hidden md:overflow-y-auto no-scrollbar */}
      {/* Alert */}
