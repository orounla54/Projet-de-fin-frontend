...
function ModalBlank({
  ...
  return (
    <>
      ...
      >
        <div ref={modalContent} className={`bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-auto max-w-lg w-full max-h-full ${endpoint === "messages" ? "absolute left-0 bottom-0" : ""}`}>
          {children}
        </div>
      </Transition>
    </>
