...
function AddEvenementTache({
  ...
  const [responsables, setResponsables] = useState(event?.responsablesAssocies);
...
//   console.log(responsables);
  ...
  useEffect(() => {
    if (tache) {
      methods.setValue("libelle", tache.libelle);
      methods.setValue("description", tache.description);
      methods.setValue("idResponsable", tache.idResponsable);
    }
  }, [tache, methods]);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (tache) {
        await axios.put(
          `${baseUrl}/evenementsSociete/taches/${tache?.id}`,
          baseDataObject,
          {
            headers: {
        ...
        await axios.post(
          `${baseUrl}/evenementsSociete/taches`,
          baseDataObject,
          {
            headers: {
              "Content-Type": "application/json",
      ...
      const errorMessage =
        error.response && error.response.data
          ...
          : "Erreur inattendue lors de l'ajout de la tache";
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between gap-2 mb-5">
                ...
                <div className="relative w-2/5">
                  <label
                    htmlFor="idResponsable"
                    className="block mb-1 text-sm font-medium"
                  >
                    Responsable <span className="text-red-500">*</span>
                  </label>
                  <select
                    {...methods.register("idResponsable", {
                      required: {
                        value: true,
                    ...
                    className={`form-select w-full ${
                      methods.formState.errors.idResponsable
                        ? "border border-red-500"
                        : ""
                    }`}
                  >
...
export default AddEvenementTache;
