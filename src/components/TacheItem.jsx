    ...
    <tr>
      ...
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div className="font-medium text-sky-800">
          <Link className="text-left" to={`/taches/${props.id}`}>
      ...
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div className="font-medium text-sky-800">
          <Link className="text-left" to={`/taches/${props.id}`}>
            <LibelleFormat libelle={props.typeTache} />
          </Link>
        </div>
      </td>
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div className="font-medium text-sky-800 text-center ">
          <LibelleFormat libelle={props.Responsables} />
        </div>
      </td>
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
