      ...
      options: {
        ...
        scales: {
          y: {
            type: "time",
            time: {
              parser: "DD-MM-YYYY", // Correspond au format de vos données
              unit: "day", // L'unité que vous voulez afficher
              displayFormats: {
                month: "MMM", // Exemple : Jan, Feb, etc.
              },
            },
            border: {
              display: false,
            ...
            ticks: {
              color: darkMode ? textColor.dark : textColor.light, // Couleur des ticks en fonction du mode
            },
          },
